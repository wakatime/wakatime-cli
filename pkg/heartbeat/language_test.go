...
func languageTests() map[string]heartbeat.Language {
	return map[string]heartbeat.Language{
		...
		"Arturo":                           heartbeat.LanguageArturo,
		...
		"Gemfile.lock":                     heartbeat.LanguageGemfileLock,
		...
		"Gettext":                          heartbeat.LanguageGettext,
		...
		"Lateralus":                        heartbeat.LanguageLateralus,
		...
		"Markless":                         heartbeat.LanguageMarkless,
		...
		"microcad":                         heartbeat.LanguageMicrocad,
		...
		"MoonBit":                          heartbeat.LanguageMoonBit,
...
func languageTestsAliases() map[string]heartbeat.Language {
	return map[string]heartbeat.Language{
		...
		"html+ruby":                   heartbeat.LanguageERB,
		...
		"ltl":                         heartbeat.LanguageLateralus,
		...
		"YAML+Jinja":                  heartbeat.LanguageSalt,
		"yaml+jinja":                  heartbeat.LanguageSalt,
		"z80":                         heartbeat.LanguageZ80Assembly,
		"zsh":                         heartbeat.LanguageBash,
		"µcad":                        heartbeat.LanguageMicrocad,
