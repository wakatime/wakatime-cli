...
func ParseLanguage(s string) (Language, bool) {
	...
	case normalizeString(languageJanetStr):
		return LanguageJanet, true
	...
	case normalizeString(languageLean4Str):
		return LanguageLean4, true
	...
	case normalizeString(languageRPGLEStr):
		return LanguageRPGLE, true
